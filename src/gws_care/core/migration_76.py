"""DB migration v0.68.12 — Remove test campaign "PRG-8BWZYZAX".
...
73.py/74.py rather than relying on DB-level FK cascade for the
campaign/visit tables.
"""
...
@brick_migration(
    "0.68.12",
    short_description="Remove test campaign PRG-8BWZYZAX and its cascade-linked visits/exams/doctor links",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration760(BrickMigration):
    @classmethod
