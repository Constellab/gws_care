"""DB migration v0.68.16 — Remove test campaign "PRG-WSGF0AAF".
...
73.py/74.py/76.py/77.py/78.py/79.py rather than relying on DB-level FK
cascade for the campaign/visit tables.
"""
...
@brick_migration(
    "0.68.16",
    short_description="Remove test campaign PRG-WSGF0AAF and its cascade-linked visits/exams/doctor links",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration800(BrickMigration):
    @classmethod
