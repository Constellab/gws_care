"""DB migration v0.62.0 — Remove test campaign Standup2026_subway."""
...
@brick_migration(
    "0.62.0",
    short_description="Delete test campaign Standup2026_subway and all related data",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration530(BrickMigration):
    @classmethod
    def migrate(
        ...
        try:
            ...
            db.execute_sql(
                "DELETE FROM gws_care_medical_program WHERE name = 'Standup2026_subway'"
            )
        except Exception:
