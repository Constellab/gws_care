"""DB migration v0.65.1 — Delete all campaign, visit, and exam data (reset)."""
...
@brick_migration(
    "0.65.1",
    short_description="Reset: delete all campaigns, visits, and exam data (retest)",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration570(BrickMigration):
    @classmethod
