"""DB migration v0.68.9 — Remove test campaign "PRG-Y95DXIQV".
...
@brick_migration(
    "0.68.9",
    short_description="Remove test campaign PRG-Y95DXIQV and its cascade-linked visits/exams/doctor links",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration730(BrickMigration):
    @classmethod
