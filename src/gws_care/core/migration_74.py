"""DB migration v0.68.10 — Remove test campaign "PRG-W4IRDNQ8" (test_sub).
...
delete-order pattern as migration_65.py/67.py/68.py/69.py/71.py/72.py/73.py
rather than relying on DB-level FK cascade for the campaign/visit tables.
"""
...
_CAMPAIGN_NUMBERS = [
    "PRG-W4IRDNQ8",  # "test_sub"
]


@brick_migration(
    "0.68.10",
    short_description="Remove test campaign PRG-W4IRDNQ8 and its cascade-linked visits/exams/doctor links",
    db_manager=CareDbManager.get_instance(),
    authenticate_sys_user=False,
)
class Migration740(BrickMigration):
    @classmethod
