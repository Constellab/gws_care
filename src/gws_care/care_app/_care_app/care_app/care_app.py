...
from .uploaded_document_detail.uploaded_document_detail_component import (
    uploaded_document_detail_page,
)
...
@rx.page(
    route="/",
    on_load=[
        PatientListState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
def index():
...
@rx.page(
    route="/patient/[patient_id_param]",
    on_load=[PatientDetailState.on_load, GeneralSettingsState.load_color_theme],
)
def patient_detail():
...
@rx.page(
    route="/accounts", on_load=[AccountListState.on_load, GeneralSettingsState.load_color_theme]
)
def account_list():
...
@rx.page(
    ...
    on_load=[AccountDetailState.on_load, GeneralSettingsState.load_color_theme],
)
def account_detail():
...
@rx.page(
    route="/exam/[exam_id_param]",
    on_load=[ExamDetailState.on_load, GeneralSettingsState.load_color_theme],
)
def exam_detail():
...
@rx.page(
    route="/visits",
    on_load=[VisitListState.on_load, LanguageState.on_load, GeneralSettingsState.load_color_theme],
)
def visits():
...
@rx.page(
    route="/consultations",
    on_load=[
        VisitListState.on_load_consultations,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/campaign-visits",
    on_load=[
        VisitListState.on_load_campaign_visits,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/doctors",
    on_load=[DoctorListState.on_load, LanguageState.on_load, GeneralSettingsState.load_color_theme],
)
def doctors():
...
@rx.page(
    route="/exam-types",
    on_load=[ExamTypesState.on_load, LanguageState.on_load, GeneralSettingsState.load_color_theme],
)
def exam_types():
...
@rx.page(
    ...
    on_load=[
        AdminState.on_load,
        NotificationsState.load_settings,
        GeneralSettingsState.on_load,
        ExamTypesState.on_load,
    ],
)
def settings():
...
@rx.page(
    route="/dashboard", on_load=[DashboardState.on_load, GeneralSettingsState.load_color_theme]
)
def dashboard():
...
@rx.page(
    route="/notifications",
    on_load=[NotificationsState.on_load, GeneralSettingsState.load_color_theme],
)
def notifications():
...
@rx.page(
    route="/campaign/[campaign_id_param]",
    on_load=[
        CampaignDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        CampaignPatientExamsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/visit/[visit_id_param]",
    on_load=[
        VisitDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/appointment/[visit_id_param]",
    on_load=[
        AppointmentDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/consultation/[visit_id_param]",
    on_load=[
        ConsultationDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/consultation/[visit_id_param]/exam/[exam_id_param]",
    on_load=[
        ConsultationDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
...
@rx.page(
    ...
    on_load=[TerrainState.on_load, LanguageState.on_load, GeneralSettingsState.load_color_theme],
)
def terrain():
...
@rx.page(
    route="/prescription/[prescription_id_param]",
    on_load=[PrescriptionDetailState.on_load, GeneralSettingsState.load_color_theme],
)
...
@rx.page(
    route="/certificate/[certificate_id_param]",
    on_load=[CertificateDetailState.on_load, GeneralSettingsState.load_color_theme],
)
...
@rx.page(
    ...
    on_load=[
        PatientAppointmentsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/my-details",
    on_load=[
        PatientDetailsState.on_load,
        PatientAccountsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        PatientConsultationsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        PatientNotificationsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/my-exams",
    on_load=[
        PatientDocumentsState.on_load_exams,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        PatientDocumentsState.on_load_prescriptions,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        PatientDocumentsState.on_load_certificates,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/my-all-documents",
    on_load=[
        PatientDocumentsState.on_load_all_documents,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    ...
    on_load=[
        UploadedDocumentDetailState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/my-assigned-exams",
    on_load=[
        DoctorAssignedExamsState.on_load,
        LanguageState.on_load,
        GeneralSettingsState.load_color_theme,
    ],
)
...
@rx.page(
    route="/switch_role",
    on_load=[SwitchRoleState.on_load, LanguageState.on_load, GeneralSettingsState.load_color_theme],
)
def switch_role():
