            ...
            rx.hstack(
                ...
                rx.select.root(
                    ...
                    rx.select.content(
                        ...
                        rx.select.item(LanguageState.tr["status_terrain_exam"], value="terrain_exam"),
                        rx.select.item(LanguageState.tr["status_sample_analysis"], value="sample_analysis"),
